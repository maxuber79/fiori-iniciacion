		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#logaligrouptestumayor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligrouptestumayor-display": {
								"semanticObject": "logaligrouptestumayor",
								"action": "display",
								"description": "Una app para umayor test",
								"title": "Lista de Alumnos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.testumayor",
									"url": sap.ui.require.toUrl("logaligroup/testumayor")
								}
							}
						}
					}
